...
CSS Color 4 and ICC sRGB formulas. It contains endpoints, official sample values,
both thresholds, and adjacent cases. `fixtures/color/derived-edge-vectors.json`
is separately labeled repository-derived evidence for quantization, alpha,
profile limits, and adversarial cases. Both are generated by
