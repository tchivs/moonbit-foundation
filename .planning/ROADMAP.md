...
- [ ] 08-07-PLAN.md — Define r2 attempt-family, terminal history, receipt, and handoff contracts.

**Wave 8** *(blocked on Wave 7 completion)*

- [ ] 08-08-PLAN.md — Wire r2 publisher/hosted seam and UTC-stable state tests.

**Wave 9** *(blocked on Wave 8 completion)*

- [ ] 08-09-PLAN.md — Establish the LF-clean r2 boundary and non-mutating AuthorityUnion handoff.

**Wave 10** *(blocked on Wave 9 completion)*

- [ ] 08-10-PLAN.md — Publish or recover core/color/image in order and close reciprocal evidence.
...
| 8. Ordered Mooncakes Publication and Registry Consumers | v0.2 | 6/10 | In Progress|  |
