...
- [x] 99-02-PLAN.md — Add exact bounded one-level composite graph classification, placement, transforms, and hostile-input behavior.
...
| 100. Portable Font Qualification | 2/5 | In Progress|  |
