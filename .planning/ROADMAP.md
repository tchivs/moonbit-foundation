...
- [ ] **Phase 50: Gray+Alpha Image Model** - Establish the explicit packed U8 two-component image contract while preserving existing image formats.
...
|-------|----------------|--------|-----------|
| 50. Gray+Alpha Image Model | 0/TBD | Not started | - |
| 51. Bounded Gray+Alpha PNG Encoding | 0/TBD | Not started | - |
