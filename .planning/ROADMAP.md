...
- [x] 98-02-PLAN.md — Add bounded optional legacy horizontal kerning with explicit limits and distinct absence, unsupported, and malformed outcomes.
...
- [ ] 99-01-PLAN.md — Repair the Phase 98 interface baseline and deliver complete transactional simple outline extraction.

**Wave 2** *(blocked on Wave 1 completion)*

- [ ] 99-02-PLAN.md — Add exact bounded one-level composite graph classification, placement, transforms, and hostile-input behavior.
...
| 99. Simple and Composite Outlines | 0/3 | Not started | - |
