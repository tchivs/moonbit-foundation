...
- [ ] 08-17-PLAN.md — Define r7 attempt-family and seven-history contracts, including r6's hosted cross-platform prepared-intent failure.

**Wave 18** *(blocked on Wave 17 completion)*

- [ ] 08-18-PLAN.md — Wire the r7 hosted seam and preserve cross-platform archive, remote-tag, exact14, snapshot, and isolation regressions.
...
| 8. Ordered Mooncakes Publication and Registry Consumers | v0.2 | 16/20 | In Progress|  |
