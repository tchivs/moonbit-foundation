...
- [ ] **Phase 53: GrayAlpha16 Model and Checked Storage** - Establish the packed U16 two-component straight-alpha source contract while preserving existing descriptors and storage behavior. (Requirements: GRAYA16-01)
