...
- [ ] **Phase 95: Shared SVG Geometry Boundary** - Make parser preflight and lowering use one checked geometry seam while retaining valid SVG behavior.
...
|-------|----------------|--------|-----------|
| 95. Shared SVG Geometry Boundary | 0/TBD | Not started | - |
