...
- [ ] **PNGE-01**: A library user can create a public PNG chunk encoder for a compatible RGB8 or straight-RGBA8 image and receives all capability, dimension, limit, and budget rejection before any encoded byte is exposed.
