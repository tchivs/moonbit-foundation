...
- [ ] **SVGPR-01**: Library users receive a documented, target-neutral SVG numeric admission contract with route-matrix tests for every supported scalar ingress and derived-value path.
