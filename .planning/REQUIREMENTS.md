...
- [x] **GRAY16-03**: Generated Gray16 cases prove both 16-bit wire-sample preservation and documented public decode canonicalization, caller-buffered eager-byte identity under zero/one/ragged capacities, frozen Gray8/RGB8/RGBA8 compatibility, and independent js/wasm/wasm-gc/native execution.
...
| --- | --- | --- |
| GRAY16-01 | Phase 47 | Complete |
| GRAY16-02 | Phase 48 | Complete |
| GRAY16-03 | Phase 49 | Complete |
