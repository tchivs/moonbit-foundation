...
- **D-03:** Keep a private Gray16 profile in the existing machine/preflight path. Extend scalar channels/row-byte facts instead of adding a second encoder, retained full-image buffer, or separate stream driver.
