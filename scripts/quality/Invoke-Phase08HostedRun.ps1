...
param(
  [Parameter(Mandatory)][ValidateSet(
    ...
    'IndexSanitizedArtifact','AssembleAuthorizationPacket','PersistAuthorizationReceipt','WriteHandoff','ValidatePreAuthorization',
  ...
  [string]$R7HistoryPath,
  [string]$R8HistoryPath,
  [string]$R9HistoryPath,
  [string]$R10HistoryPath,
  [string]$R11HistoryPath,
  [string]$R12HistoryPath,
  [ValidateSet('mutation_authorized','exact_existing')][string]$AuthorityVariant,
  [string]$HandoffPath,
  [string]$PreAuthorizationPath,
  [string]$TempRoot,
  [object]$CreatedAt,
  [string]$PriorRunId='',
...
function Write-P08AuthorizationReceipt {
  ...
  if($packet.schema_version -cne 'mnf-phase08-mutation-authorization-packet/1' -or $packet.release_ref -cne 'refs/tags/modules-v0.1.0-r13' -or
    ...
    Throw-P08HostedRule 'P08-RECEIPT-PACKET' 'Authorization packet is not the exact digest-bound r13 packet.'
  }
...
function Write-P08ActiveAttempt {
  ...
  $pathFields=@('boundary_locator_path','artifact_index_path','attempt_zero_history_path','r1_history_path','r2_history_path','r3_history_path','r4_history_path','r5_history_path','r6_history_path','r7_history_path','r8_history_path','r9_history_path','r10_history_path','r11_history_path','r12_history_path')
  ...
  $value=[pscustomobject][ordered]@{
    schema_version='mnf-phase08-active-attempt/1';release_ref='refs/tags/modules-v0.1.0-r13';boundary_sha=[string]$Bindings.boundary_sha;execution_root=$root
    ...
    r7_history_path=[IO.Path]::GetFullPath([string]$Bindings.r7_history_path);r7_history_sha256=Get-P08Sha256 ([string]$Bindings.r7_history_path)
    r8_history_path=[IO.Path]::GetFullPath([string]$Bindings.r8_history_path);r8_history_sha256=Get-P08Sha256 ([string]$Bindings.r8_history_path)
    r9_history_path=[IO.Path]::GetFullPath([string]$Bindings.r9_history_path);r9_history_sha256=Get-P08Sha256 ([string]$Bindings.r9_history_path)
    r10_history_path=[IO.Path]::GetFullPath([string]$Bindings.r10_history_path);r10_history_sha256=Get-P08Sha256 ([string]$Bindings.r10_history_path)
    r11_history_path=[IO.Path]::GetFullPath([string]$Bindings.r11_history_path);r11_history_sha256=Get-P08Sha256 ([string]$Bindings.r11_history_path)
    r12_history_path=[IO.Path]::GetFullPath([string]$Bindings.r12_history_path);r12_history_sha256=Get-P08Sha256 ([string]$Bindings.r12_history_path)
...
function Open-P08ActiveAttempt([Parameter(Mandatory)][string]$Path) {
  ...
  $names=@('schema_version','release_ref','boundary_sha','execution_root','boundary_locator_path','boundary_locator_sha256','artifact_root','artifact_index_path','artifact_index_sha256','attempt_zero_history_path','attempt_zero_history_sha256','r1_history_path','r1_history_sha256','r2_history_path','r2_history_sha256','r3_history_path','r3_history_sha256','r4_history_path','r4_history_sha256','r5_history_path','r5_history_sha256','r6_history_path','r6_history_sha256','r7_history_path','r7_history_sha256','r8_history_path','r8_history_sha256','r9_history_path','r9_history_sha256','r10_history_path','r10_history_sha256','r11_history_path','r11_history_sha256','r12_history_path','r12_history_sha256','historical_history_set_sha256','authority_variant','mutation_authorization_packet_path','mutation_authorization_packet_sha256','authorization_receipt_path','authorization_receipt_sha256','exact_existing_authority_path','exact_existing_authority_sha256','updated_at_utc','active_attempt_sha256')
  if((@($value.PSObject.Properties.Name)-join ',')-cne($names-join ',')-or$value.schema_version-cne'mnf-phase08-active-attempt/1'-or$value.release_ref-cne'refs/tags/modules-v0.1.0-r13'){Throw-P08HostedRule 'P08-ACTIVE-CLOSED' 'Active attempt shape drifted.'}
  $history=Get-ReleaseInitialHistoryBinding
  if($value.attempt_zero_history_sha256-cne$history.historical_attempt_zero_sha256-or$value.r1_history_sha256-cne$history.historical_r1_sha256-or$value.r2_history_sha256-cne$history.historical_r2_sha256-or$value.r3_history_sha256-cne$history.historical_r3_sha256-or$value.r4_history_sha256-cne$history.historical_r4_sha256-or$value.r5_history_sha256-cne$history.historical_r5_sha256-or$value.r6_history_sha256-cne$history.historical_r6_sha256-or$value.r7_history_sha256-cne$history.historical_r7_sha256-or$value.r8_history_sha256-cne$history.historical_r8_sha256-or$value.r9_history_sha256-cne$history.historical_r9_sha256-or$value.r10_history_sha256-cne$history.historical_r10_sha256-or$value.r11_history_sha256-cne$history.historical_r11_sha256-or$value.r12_history_sha256-cne$history.historical_r12_sha256-or$value.historical_history_set_sha256-cne$history.historical_history_set_sha256){Throw-P08HostedRule 'P08-ACTIVE-DIGEST' 'Active attempt history family drifted.'}
  ...
  foreach($pair in @(@('boundary_locator_path','boundary_locator_sha256'),@('artifact_index_path','artifact_index_sha256'),@('attempt_zero_history_path','attempt_zero_history_sha256'),@('r1_history_path','r1_history_sha256'),@('r2_history_path','r2_history_sha256'),@('r3_history_path','r3_history_sha256'),@('r4_history_path','r4_history_sha256'),@('r5_history_path','r5_history_sha256'),@('r6_history_path','r6_history_sha256'),@('r7_history_path','r7_history_sha256'),@('r8_history_path','r8_history_sha256'),@('r9_history_path','r9_history_sha256'),@('r10_history_path','r10_history_sha256'),@('r11_history_path','r11_history_sha256'),@('r12_history_path','r12_history_sha256'),@('mutation_authorization_packet_path','mutation_authorization_packet_sha256'),@('authorization_receipt_path','authorization_receipt_sha256'),@('exact_existing_authority_path','exact_existing_authority_sha256'))){
...
function Write-P08HostedHandoff {
  ...
  $bindings=[ordered]@{
    ...
    r2_history_path=$active.r2_history_path;r2_history_sha256=$active.r2_history_sha256;r3_history_path=$active.r3_history_path;r3_history_sha256=$active.r3_history_sha256;r4_history_path=$active.r4_history_path;r4_history_sha256=$active.r4_history_sha256;r5_history_path=$active.r5_history_path;r5_history_sha256=$active.r5_history_sha256;r6_history_path=$active.r6_history_path;r6_history_sha256=$active.r6_history_sha256;r7_history_path=$active.r7_history_path;r7_history_sha256=$active.r7_history_sha256;r8_history_path=$active.r8_history_path;r8_history_sha256=$active.r8_history_sha256;r9_history_path=$active.r9_history_path;r9_history_sha256=$active.r9_history_sha256;r10_history_path=$active.r10_history_path;r10_history_sha256=$active.r10_history_sha256;r11_history_path=$active.r11_history_path;r11_history_sha256=$active.r11_history_sha256;r12_history_path=$active.r12_history_path;r12_history_sha256=$active.r12_history_sha256;historical_history_set_sha256=$active.historical_history_set_sha256
...
function Assert-P08PreAuthorization {
  ...
  if([IO.Path]::GetFullPath([string]$Projection.fixed_handoff_path) -cne [IO.Path]::GetFullPath($ExpectedHandoffPath) -or $null -ne $Projection.fixed_handoff_sha256 -or (Test-Path -LiteralPath $ExpectedHandoffPath)){
    Throw-P08HostedRule 'P08-PREAUTH-HANDOFF' 'Pre-authorization requires the absent fixed r10 handoff path.'
  }
  if([int]$Projection.mutation_count -ne 0 -or [int]$Projection.output_write_count -ne 0 -or $null -ne $Projection.active_attempt_path -or $null -ne $Projection.authorization_receipt_path -or $null -ne $Projection.authorization_receipt_sha256){
    Throw-P08HostedRule 'P08-PREAUTH-ZERO-MUTATION' 'Pre-authorization must not contain an active attempt, receipt, or mutation.'
  }
  $hasExact=$null -ne $Projection.exact_existing_authority_path
  $hasPacket=$null -ne $Projection.mutation_authorization_packet_path
  if($hasExact -eq $hasPacket){Throw-P08HostedRule 'P08-PREAUTH-AUTHORITY' 'Exactly one zero-mutation authority variant is required.'}
  foreach($pair in @(@('exact_existing_authority_path','exact_existing_authority_sha256'),@('mutation_authorization_packet_path','mutation_authorization_packet_sha256'),@('observation_path','observation_sha256'))){
    $path=$Projection.($pair[0]);$digest=$Projection.($pair[1])
    if($null -eq $path){if($null -ne $digest){Throw-P08HostedRule 'P08-PREAUTH-DIGEST' "Null '$($pair[0])' has a digest."};continue}
    if([string]$digest -cnotmatch '^[0-9a-f]{64}$' -or -not(Test-Path -LiteralPath $path -PathType Leaf) -or (Get-P08Sha256 $path) -cne [string]$digest){Throw-P08HostedRule 'P08-PREAUTH-DIGEST' "Pre-authorization digest '$($pair[0])' drifted."}
  }
  if($hasExact){
...
function New-P08PreparedAttempt {
  ...
  if($control.initial_attempt_family.current_attempt -cne 'r13' -or $history.Count -ne 13 -or ($history.attempt -join ',') -cne 'attempt_zero,r1,r2,r3,r4,r5,r6,r7,r8,r9,r10,r11,r12' -or
      ($history.release_ref -join ',') -cne 'refs/tags/modules-v0.1.0,refs/tags/modules-v0.1.0-r1,refs/tags/modules-v0.1.0-r2,refs/tags/modules-v0.1.0-r3,refs/tags/modules-v0.1.0-r4,refs/tags/modules-v0.1.0-r5,refs/tags/modules-v0.1.0-r6,refs/tags/modules-v0.1.0-r7,refs/tags/modules-v0.1.0-r8,refs/tags/modules-v0.1.0-r9,refs/tags/modules-v0.1.0-r10,refs/tags/modules-v0.1.0-r11,refs/tags/modules-v0.1.0-r12' -or
      @($history|Where-Object{$_.mutation_performed-ne$false-or$_.authority_acquired-ne$false}).Count -ne 0){
    Throw-P08HostedRule 'P08-PREPARE-HISTORY' 'The exact thirteen-entry terminal-negative history is required.'
  }
  $historicalPolicy=$history[12]
  if($historicalPolicy.PSObject.Properties.Name -ccontains 'active_attempt_path' -or $historicalPolicy.attempt -cne 'r12' -or $historicalPolicy.release_ref -cne 'refs/tags/modules-v0.1.0-r12' -or
      $historicalPolicy.source_sha -cne '5e7b19cdc74ec11d5c524ff34a36c266b15bba39' -or $historicalPolicy.tag_object_sha -cne '57b76c9f9044d3190acc1e4c3fb7ada516f4dece' -or
      $historicalPolicy.tag_peeled_source_sha -cne '5e7b19cdc74ec11d5c524ff34a36c266b15bba39' -or $historicalPolicy.failure_code -cne 'REL01-REF' -or
      $historicalPolicy.record_sha256 -cne '92397fbdfc679f154382928ee6f94c57e46b40b7c5f7e8d65759b0165d6c96a8' -or
      $historicalPolicy.record_sha256 -cne (Get-P08SelfExcludingDigest $historicalPolicy 'record_sha256')){
    Throw-P08HostedRule 'P08-PREPARE-HISTORICAL-BINDING' 'Historical r12 record is not the exact protected clone-policy terminal schema.'
  }
  if(-not [string]::IsNullOrWhiteSpace($HistoricalRunId) -or $HistoricalRunAttempt -ne 0 -or $historicalPolicy.hosted_run_present -ne $false -or
      ...
      $HistoricalReleaseRef -cne [string]$historicalPolicy.release_ref -or $HistoricalSourceSha -cne [string]$historicalPolicy.source_sha -or
       $historicalPolicy.tag_object_sha -cne '57b76c9f9044d3190acc1e4c3fb7ada516f4dece' -or $historicalPolicy.tag_peeled_source_sha -cne '5e7b19cdc74ec11d5c524ff34a36c266b15bba39' -or
       $historicalPolicy.reason -cne 'terminal_tag_before_script_ref_agreement_failure' -or $historicalPolicy.clean_clone_tag_verified -ne $true -or
      $historicalPolicy.credential_accessed -ne $false -or
      @('prepared_bundle_count','publisher_dry_run_count','observation_count','authorization_packet_count','authorization_receipt_count',
        'handoff_count','publish_one_count','registry_operation_count','mutation_count','successor_count').Where({[int]$historicalPolicy.$_ -ne 0}).Count -ne 0 -or
      $historicalPolicy.mutation_performed -ne $false -or $historicalPolicy.authority_acquired -ne $false){
    Throw-P08HostedRule 'P08-PREPARE-HISTORICAL-BINDING' 'Historical r12 terminal binding differs from release control.'
  }
  ...
  try {
    ...
    if($intentDigest -cnotmatch '^[0-9a-f]{64}$' -or (Get-P08Sha256 $intentPath) -cne $intentDigest -or
       ...
       Throw-P08HostedRule 'P08-PREPARE-INTENT-BINDING' 'Fresh r13 intent/root binding is invalid.'
    }
    ...
    $attemptZero=$historyProjections[0];$r1Negative=$historyProjections[1];$r2Negative=$historyProjections[2];$r3Negative=$historyProjections[3];$r4Negative=$historyProjections[4];$r5Negative=$historyProjections[5];$r6Negative=$historyProjections[6];$r7Negative=$historyProjections[7];$r8Negative=$historyProjections[8];$r9Negative=$historyProjections[9];$r10Negative=$historyProjections[10];$r11Negative=$historyProjections[11];$r12Negative=$historyProjections[12]
    ...
    $r8HistoryPath=Join-Path $stageRoot 'historical/r8.json';Write-P08ExclusiveJson $r8HistoryPath $r8Negative
    $r9HistoryPath=Join-Path $stageRoot 'historical/r9.json';Write-P08ExclusiveJson $r9HistoryPath $r9Negative
    $r10HistoryPath=Join-Path $stageRoot 'historical/r10.json';Write-P08ExclusiveJson $r10HistoryPath $r10Negative
    $r11HistoryPath=Join-Path $stageRoot 'historical/r11.json';Write-P08ExclusiveJson $r11HistoryPath $r11Negative
    $r12HistoryPath=Join-Path $stageRoot 'historical/r12.json';Write-P08ExclusiveJson $r12HistoryPath $r12Negative
    $attemptZeroDigest=Get-P08Sha256 $attemptZeroPath;$r1HistoryDigest=Get-P08Sha256 $r1HistoryPath;$r2HistoryDigest=Get-P08Sha256 $r2HistoryPath;$r3HistoryDigest=Get-P08Sha256 $r3HistoryPath;$r4HistoryDigest=Get-P08Sha256 $r4HistoryPath;$r5HistoryDigest=Get-P08Sha256 $r5HistoryPath;$r6HistoryDigest=Get-P08Sha256 $r6HistoryPath;$r7HistoryDigest=Get-P08Sha256 $r7HistoryPath;$r8HistoryDigest=Get-P08Sha256 $r8HistoryPath;$r9HistoryDigest=Get-P08Sha256 $r9HistoryPath;$r10HistoryDigest=Get-P08Sha256 $r10HistoryPath;$r11HistoryDigest=Get-P08Sha256 $r11HistoryPath;$r12HistoryDigest=Get-P08Sha256 $r12HistoryPath
    $historySet=([Convert]::ToHexString([Security.Cryptography.SHA256]::HashData([Text.UTF8Encoding]::new($false).GetBytes((@($attemptZeroDigest,$r1HistoryDigest,$r2HistoryDigest,$r3HistoryDigest,$r4HistoryDigest,$r5HistoryDigest,$r6HistoryDigest,$r7HistoryDigest,$r8HistoryDigest,$r9HistoryDigest,$r10HistoryDigest,$r11HistoryDigest,$r12HistoryDigest)-join"`n"))))).ToLowerInvariant()
    ...
    $genesisCommand=[pscustomobject][ordered]@{
      ...
      outcome='accepted';recorded_at_utc=$commitTime;run_identity=[pscustomobject][ordered]@{repository='tchivs/moonbit-foundation';run_id='1';artifact_name='publisher-genesis-r10';artifact_sequence=0}
    }
    ...
    $records=@(
      ...
      New-P08PrepareIndexRecord -LogicalKey 'prepare|historical|r7' -Kind 'HistoricalNegative' -RelativePath 'historical/r7.json' -AbsolutePath $r7HistoryPath -ContentDigest $r7HistoryDigest -Binding $indexBinding
      New-P08PrepareIndexRecord -LogicalKey 'prepare|historical|r8' -Kind 'HistoricalNegative' -RelativePath 'historical/r8.json' -AbsolutePath $r8HistoryPath -ContentDigest $r8HistoryDigest -Binding $indexBinding
      New-P08PrepareIndexRecord -LogicalKey 'prepare|historical|r9' -Kind 'HistoricalNegative' -RelativePath 'historical/r9.json' -AbsolutePath $r9HistoryPath -ContentDigest $r9HistoryDigest -Binding $indexBinding
      New-P08PrepareIndexRecord -LogicalKey 'prepare|historical|r10' -Kind 'HistoricalNegative' -RelativePath 'historical/r10.json' -AbsolutePath $r10HistoryPath -ContentDigest $r10HistoryDigest -Binding $indexBinding
       New-P08PrepareIndexRecord -LogicalKey 'prepare|historical|r11' -Kind 'HistoricalNegative' -RelativePath 'historical/r11.json' -AbsolutePath $r11HistoryPath -ContentDigest $r11HistoryDigest -Binding $indexBinding
       New-P08PrepareIndexRecord -LogicalKey 'prepare|historical|r12' -Kind 'HistoricalNegative' -RelativePath 'historical/r12.json' -AbsolutePath $r12HistoryPath -ContentDigest $r12HistoryDigest -Binding $indexBinding
    )
    ...
    [pscustomobject][ordered]@{
      ...
      index_path=[IO.Path]::GetFullPath((Join-Path $artifactRoot 'index.json'));root_intent_sha256=$intentDigest;intent_sha256=$intentDigest
       prepared_manifest_sha256=$preparedDigest;historical_record_path=[IO.Path]::GetFullPath((Join-Path $artifactRoot 'historical/r12.json'))
       attempt_zero_history_path=[IO.Path]::GetFullPath((Join-Path $artifactRoot 'historical/attempt-zero.json'));r1_history_path=[IO.Path]::GetFullPath((Join-Path $artifactRoot 'historical/r1.json'));r2_history_path=[IO.Path]::GetFullPath((Join-Path $artifactRoot 'historical/r2.json'));r3_history_path=[IO.Path]::GetFullPath((Join-Path $artifactRoot 'historical/r3.json'));r4_history_path=[IO.Path]::GetFullPath((Join-Path $artifactRoot 'historical/r4.json'));r5_history_path=[IO.Path]::GetFullPath((Join-Path $artifactRoot 'historical/r5.json'));r6_history_path=[IO.Path]::GetFullPath((Join-Path $artifactRoot 'historical/r6.json'));r7_history_path=[IO.Path]::GetFullPath((Join-Path $artifactRoot 'historical/r7.json'));r8_history_path=[IO.Path]::GetFullPath((Join-Path $artifactRoot 'historical/r8.json'));r9_history_path=[IO.Path]::GetFullPath((Join-Path $artifactRoot 'historical/r9.json'));r10_history_path=[IO.Path]::GetFullPath((Join-Path $artifactRoot 'historical/r10.json'));r11_history_path=[IO.Path]::GetFullPath((Join-Path $artifactRoot 'historical/r11.json'));r12_history_path=[IO.Path]::GetFullPath((Join-Path $artifactRoot 'historical/r12.json'));historical_history_set_sha256=$historySet
...
function Invoke-P08HostedDispatch {
  param([string]$Operation,[string]$Repo,[string]$WorkflowPath,[string]$Ref,[string]$Sha,[string]$RootIntent,[string]$CurrentIntent,[string]$PreparedDigest,[string]$Module,[string]$PriorId,[string]$PriorArtifact,[string]$Packet,[string]$Receipt,[string]$AttemptZeroHistory,[string]$R1History,[string]$R2History,[string]$R3History,[string]$R4History,[string]$R5History,[string]$R6History,[string]$R7History,[string]$R8History,[string]$R9History,[string]$R10History,[string]$R11History,[string]$R12History)
  if([string]::IsNullOrWhiteSpace($AttemptZeroHistory)-or[string]::IsNullOrWhiteSpace($R1History)-or[string]::IsNullOrWhiteSpace($R2History)-or[string]::IsNullOrWhiteSpace($R3History)-or[string]::IsNullOrWhiteSpace($R4History)-or[string]::IsNullOrWhiteSpace($R5History)-or[string]::IsNullOrWhiteSpace($R6History)-or[string]::IsNullOrWhiteSpace($R7History)-or[string]::IsNullOrWhiteSpace($R8History)-or[string]::IsNullOrWhiteSpace($R9History)-or[string]::IsNullOrWhiteSpace($R10History)-or[string]::IsNullOrWhiteSpace($R11History)-or[string]::IsNullOrWhiteSpace($R12History)){Throw-P08HostedRule 'P08-HOSTED-HISTORY' 'All thirteen terminal-negative history files are required for dispatch.'}
  $history=Get-ReleaseInitialHistoryBinding
  $historyFiles=@($AttemptZeroHistory,$R1History,$R2History,$R3History,$R4History,$R5History,$R6History,$R7History,$R8History,$R9History,$R10History,$R11History,$R12History);$historyDigests=@($historyFiles|ForEach-Object{Get-P08Sha256 $_})
  if(($historyDigests-join',')-cne(@($history.historical_attempt_zero_sha256,$history.historical_r1_sha256,$history.historical_r2_sha256,$history.historical_r3_sha256,$history.historical_r4_sha256,$history.historical_r5_sha256,$history.historical_r6_sha256,$history.historical_r7_sha256,$history.historical_r8_sha256,$history.historical_r9_sha256,$history.historical_r10_sha256,$history.historical_r11_sha256,$history.historical_r12_sha256)-join',')){Throw-P08HostedRule 'P08-HOSTED-HISTORY' 'Individual terminal-negative history files drifted.'}
