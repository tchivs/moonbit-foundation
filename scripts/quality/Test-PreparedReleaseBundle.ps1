...
try {
  ...
  $historySetSha = '39e45ed9aecf1788d106a043dd4b421243a577b66534d0748ca61937a0de86a8'
  ...
  $intent = [ordered]@{
    ...
    release_ref='refs/tags/modules-v0.1.0-r9'; source_sha=$sourceSha; correction_sequence=0; toolchain=$toolchain
  ...
  Write-JsonFixture -Path (Join-Path $inputRoot 'intent\root-binding.json') -Value ([ordered]@{
    root_intent_sha256=$intentSha; intent_sha256=$intentSha; source_sha=$sourceSha; release_ref='refs/tags/modules-v0.1.0-r9'
  })
  Write-JsonFixture -Path (Join-Path $inputRoot 'request.json') -Value ([ordered]@{
    repository='tchivs/moonbit-foundation'; actor='tchivs'; release_ref='refs/tags/modules-v0.1.0-r9'; source_sha=$sourceSha
    ...
    historical_attempt_zero_sha256=$attemptZeroSha; historical_r1_sha256=$r1Sha; historical_r2_sha256=$r2Sha; historical_r3_sha256=$r3Sha; historical_r4_sha256=$r4Sha; historical_r5_sha256=$r5Sha; historical_r6_sha256=$r6Sha; historical_r7_sha256=$r7Sha; historical_r8_sha256=$r8Sha
  ...
  $common = @{
    ...
    ReleaseRef='refs/tags/modules-v0.1.0-r9'; SourceSha=$sourceSha; RootIntentSha256=$intentSha; IntentSha256=$intentSha
    HistoricalAttemptZeroSha256=$attemptZeroSha; HistoricalR1Sha256=$r1Sha; HistoricalR2Sha256=$r2Sha; HistoricalR3Sha256=$r3Sha; HistoricalR4Sha256=$r4Sha; HistoricalR5Sha256=$r5Sha; HistoricalR6Sha256=$r6Sha; HistoricalR7Sha256=$r7Sha; HistoricalR8Sha256=$r8Sha; HistoricalHistorySetSha256=$historySetSha
    RunMode='start'
  }
  $validation = @{} + $common
