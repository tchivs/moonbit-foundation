...
function Get-ReleaseAuthorizationReceiptProjection {
  ...
  return [pscustomobject][ordered]@{
    ...
    historical_r1_sha256=[string]$Receipt.historical_r1_sha256;historical_r2_sha256=[string]$Receipt.historical_r2_sha256;historical_r3_sha256=[string]$Receipt.historical_r3_sha256;historical_r4_sha256=[string]$Receipt.historical_r4_sha256;historical_r5_sha256=[string]$Receipt.historical_r5_sha256;historical_r6_sha256=[string]$Receipt.historical_r6_sha256;historical_r7_sha256=[string]$Receipt.historical_r7_sha256;historical_r8_sha256=[string]$Receipt.historical_r8_sha256;historical_r9_sha256=[string]$Receipt.historical_r9_sha256
...
function New-ReleaseAuthorizationReceipt {
  ...
  $value=[pscustomobject][ordered]@{
    schema_version='mnf-phase08-authorization-receipt/1';release_ref='refs/tags/modules-v0.1.0-r12';boundary_sha=$BoundarySha;source_sha=$SourceSha
    ...
    historical_r2_sha256=$history.historical_r2_sha256;historical_r3_sha256=$history.historical_r3_sha256;historical_r4_sha256=$history.historical_r4_sha256;historical_r5_sha256=$history.historical_r5_sha256;historical_r6_sha256=$history.historical_r6_sha256;historical_r7_sha256=$history.historical_r7_sha256;historical_r8_sha256=$history.historical_r8_sha256;historical_r9_sha256=$history.historical_r9_sha256;historical_r10_sha256=$history.historical_r10_sha256;historical_r11_sha256=$history.historical_r11_sha256;historical_history_set_sha256=$history.historical_history_set_sha256
...
function Assert-ReleaseAuthorizationReceipt {
  ...
  if ($Receipt.schema_version -cne 'mnf-phase08-authorization-receipt/1' -or $Receipt.release_ref -cne 'refs/tags/modules-v0.1.0-r12' -or
  ...
  $history=Get-ReleaseInitialHistoryBinding
  foreach($name in @('historical_attempt_zero_sha256','historical_r1_sha256','historical_r2_sha256','historical_r3_sha256','historical_r4_sha256','historical_r5_sha256','historical_r6_sha256','historical_r7_sha256','historical_r8_sha256','historical_r9_sha256','historical_r10_sha256','historical_r11_sha256','historical_history_set_sha256')){if([string]$Receipt.$name -cne [string]$history.$name){Throw-ReleaseRule -Id 'REL04-HISTORY-BINDING' -Message "receipt history binding drifted for $name."}}
...
function New-ReleasePhase08Handoff {
  ...
  $value=[ordered]@{}
  foreach($name in @('schema_version','release_ref','boundary_sha','execution_root','boundary_locator_path','boundary_locator_sha256','active_attempt_path','active_attempt_sha256','artifact_root','artifact_index_path','artifact_index_sha256','attempt_zero_history_path','attempt_zero_history_sha256','r1_history_path','r1_history_sha256','r2_history_path','r2_history_sha256','r3_history_path','r3_history_sha256','r4_history_path','r4_history_sha256','r5_history_path','r5_history_sha256','r6_history_path','r6_history_sha256','r7_history_path','r7_history_sha256','r8_history_path','r8_history_sha256','r9_history_path','r9_history_sha256','r10_history_path','r10_history_sha256','r11_history_path','r11_history_sha256','r12_history_path','r12_history_sha256','historical_history_set_sha256')){
...
function Assert-ReleasePhase08Handoff {
  ...
  if ($Handoff.schema_version -cne 'mnf-phase08-handoff/1' -or $Handoff.release_ref -cne 'refs/tags/modules-v0.1.0-r13' -or $Handoff.boundary_sha -cnotmatch '^[0-9a-f]{40}$') { Throw-ReleaseRule -Id 'REL04-HANDOFF-BINDING' -Message 'handoff identity drifted.' }
  ...
  $history=Get-ReleaseInitialHistoryBinding
  foreach($pair in @(@('attempt_zero_history_sha256','historical_attempt_zero_sha256'),@('r1_history_sha256','historical_r1_sha256'),@('r2_history_sha256','historical_r2_sha256'),@('r3_history_sha256','historical_r3_sha256'),@('r4_history_sha256','historical_r4_sha256'),@('r5_history_sha256','historical_r5_sha256'),@('r6_history_sha256','historical_r6_sha256'),@('r7_history_sha256','historical_r7_sha256'),@('r8_history_sha256','historical_r8_sha256'),@('r9_history_sha256','historical_r9_sha256'),@('r10_history_sha256','historical_r10_sha256'),@('r11_history_sha256','historical_r11_sha256'),@('r12_history_sha256','historical_r12_sha256'))){if([string]$Handoff.($pair[0]) -cne [string]$history.($pair[1])){Throw-ReleaseRule -Id 'REL04-HISTORY-BINDING' -Message "handoff history binding drifted for $($pair[0])."}}
...
function Assert-ReleaseIntentObject {
  ...
  if ($kind -ceq 'initial') {
    ...
    if (@($policy.initial_attempt_family.terminal_negative_history.source_sha) -ccontains [string]$Intent.source_sha) { Throw-ReleaseRule -Id 'REL01-HISTORICAL-SOURCE' -Message 'terminal attempt-zero or r1 through r8 source cannot be current r9 authority.' }
  } else {
