...
function Assert-PublisherRequest {
  ...
  if (@($history | Where-Object { $_ -cnotmatch '^[0-9a-f]{64}$' }).Count -ne 0 -or (@($history | Select-Object -Unique)).Count -ne 9 -or
      ...
      $historySet -cne '39e45ed9aecf1788d106a043dd4b421243a577b66534d0748ca61937a0de86a8') {
    Throw-PublisherRule 'PUB16-HISTORY' 'The exact nine terminal-negative histories and their ordered set digest are required.'
  }
