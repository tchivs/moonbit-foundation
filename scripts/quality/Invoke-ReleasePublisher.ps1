...
function Assert-PublisherRequest {
  ...
  $expectedHistory=@(
    ...
    '6edf89e7afb98dca1e81e3d5db9ff8a47f96dbfb2919bdaeb176c76c52c581ec','1d524890dd5f0c11e58bcd2884c2d4623e02759a5ff801f2554fcc2ae654895f','def1bf53a3305c72360bebb651f56d28cdcaac83150e76e3c3134962ade4e9d1'
  )
  ...
  if (@($history | Where-Object { $_ -cnotmatch '^[0-9a-f]{64}$' }).Count -ne 0 -or (@($history | Select-Object -Unique)).Count -ne 12 -or
      ...
      $historySet -cne '5394421289924d7712034b43d7e732a7ff7aec3276d1ddab4846861788d8a4be') {
    Throw-PublisherRule 'PUB16-HISTORY' 'The exact twelve terminal-negative histories and their ordered set digest are required.'
  }
