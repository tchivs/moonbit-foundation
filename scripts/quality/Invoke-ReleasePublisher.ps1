...
function Assert-PublisherRequest {
  ...
  $expectedHistory=@(
    ...
    '6edf89e7afb98dca1e81e3d5db9ff8a47f96dbfb2919bdaeb176c76c52c581ec','1d524890dd5f0c11e58bcd2884c2d4623e02759a5ff801f2554fcc2ae654895f','def1bf53a3305c72360bebb651f56d28cdcaac83150e76e3c3134962ade4e9d1','92397fbdfc679f154382928ee6f94c57e46b40b7c5f7e8d65759b0165d6c96a8'
  )
  ...
  if (@($history | Where-Object { $_ -cnotmatch '^[0-9a-f]{64}$' }).Count -ne 0 -or (@($history | Select-Object -Unique)).Count -ne 13 -or
      ...
      $historySet -cne '961780e02672005c9dfb19299fc81a0531fb58081de3ee2a78274dda88f630e5') {
    Throw-PublisherRule 'PUB16-HISTORY' 'The exact thirteen terminal-negative histories and their ordered set digest are required.'
  }
