...
function Assert-PngFoundationPolicy {
  ...
  $sources = @('moon.pkg', 'png.mbt', 'structural.mbt', 'deflate_bits.mbt', 'deflate_huffman.mbt', 'deflate_inflate.mbt', 'raster_decode.mbt', 'encode.mbt', 'generated_vectors.mbt')
  $files = @('moon.pkg', 'png.mbt', 'png_test.mbt', 'structural.mbt', 'structural_wbtest.mbt', 'deflate_bits.mbt', 'deflate_huffman.mbt', 'deflate_inflate.mbt', 'deflate_wbtest.mbt', 'raster_decode.mbt', 'raster_decode_wbtest.mbt', 'encode.mbt', 'encode_test.mbt', 'encode_wbtest.mbt', 'generated_vectors.mbt', 'generated_vectors_test.mbt', 'generated_decode_vectors_test.mbt')
...
function Assert-PngQualificationNegativeFixtures {
  ...
  Confirm-PngRejected 'extra package file' { Assert-ExactSet 'PNG files' @($sources + 'png_test.mbt','structural_wbtest.mbt','deflate_wbtest.mbt','raster_decode_wbtest.mbt','encode_test.mbt','encode_wbtest.mbt','generated_vectors_test.mbt','stream.mbt') @($sources + 'png_test.mbt','structural_wbtest.mbt','deflate_wbtest.mbt','raster_decode_wbtest.mbt','encode_test.mbt','encode_wbtest.mbt','generated_vectors_test.mbt') } 'count mismatch'
