...
function Invoke-PngQualityLane {
  ...
  Invoke-PngQualityStage 'PNG exact package allowlist' {
    ...
    $expected = @('png', 'png/deflate_bits.mbt', 'png/deflate_huffman.mbt', 'png/deflate_inflate.mbt', 'png/deflate_wbtest.mbt', 'png/generated_decode_vectors_test.mbt', 'png/generated_vectors.mbt', 'png/generated_vectors_test.mbt', 'png/moon.pkg', 'png/png.mbt', 'png/png_test.mbt', 'png/raster_decode.mbt', 'png/raster_decode_wbtest.mbt', 'png/structural.mbt', 'png/structural_wbtest.mbt')
