...
$expectedInitialHistory = [ordered]@{
  ...
  set = '48de74c184100e34651e9e050e6949b252414746d13f78e04855fd28b69c8580'
}
$inventory = @(
...
function Assert-PreparedJournalBinding {
  ...
  if ($ReleaseRef -ceq 'refs/tags/modules-v0.1.0-r8' -and
    ...
    Throw-PreparedRule 'PREP10-JOURNAL-BINDING' 'r8 must be a fresh initial root with no predecessor.'
  }
}
