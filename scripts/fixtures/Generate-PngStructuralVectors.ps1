...
function Get-CaseBytes([string]$Id) {
  ...
  switch ($Id) {
    ...
    'semantic-trns' { return Get-Semantic 'tRNS' }; 'semantic-chrm' { return Get-Semantic 'cHRM' }; 'semantic-gama' { return Get-Semantic 'gAMA' }; 'semantic-iccp' { return Get-Semantic 'iCCP' }; 'semantic-sbit' { return Get-Semantic 'sBIT' }; 'semantic-srgb' { return Get-Semantic 'sRGB' }; 'semantic-cicp' { return Get-Semantic 'cICP' }; 'semantic-mdcv' { return Get-Semantic 'mDCv' }; 'semantic-clli' { return Get-Semantic 'cLLi' }; 'semantic-actl' { return Get-Semantic 'acTL' }; 'semantic-fctl' { return Get-Semantic 'fcTL' }; 'semantic-fdat' { return Get-Semantic 'fdAT' }
